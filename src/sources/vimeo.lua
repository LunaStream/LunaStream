...
function Vimeo:loadStream(track)
    ...
    local playbackUrl = data.request and data.request.files and data.request.files.hls and data.request.files.hls.cdns and data.request.files.hls.cdns[data.request.files.hls.default_cdn].url
